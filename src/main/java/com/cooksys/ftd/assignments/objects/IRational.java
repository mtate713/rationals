...
interface IRational {
	...
	default IRational add(IRational that) throws IllegalArgumentException {
		if (that == null)
			...
			return construct(((that.getNumerator() * this.getDenominator()) + (this.getNumerator() * that.getDenominator())), (that.getDenominator() * this.getDenominator()));
	}
	...
	default IRational sub(IRational that) throws IllegalArgumentException {
		if (that == null)
			...
			return construct(((this.getNumerator() * that.getDenominator()) - (that.getNumerator() * this.getDenominator())), (that.getDenominator() * this.getDenominator()));
	}
	...
	default IRational mul(IRational that) throws IllegalArgumentException {
		if (that == null)
			...
			return construct((that.getNumerator() * this.getNumerator()), (that.getDenominator() * this.getDenominator()));
	}
